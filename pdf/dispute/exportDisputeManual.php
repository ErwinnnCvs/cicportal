...
$getDispute = $dbh2->query("SELECT * from contract where fld_id > 9434 and fld_id = 11487  LIMIT 1");
...
$pdf->SetFont('helvetica', 'B', 9);
$pdf->Cell(8, 5, '', 0, 0, 'L', 0, '', 0, false, 'T', 'M');
$pdf->Cell(70, 5, 'DRCP Remarks', 0, 0, 'L', 0, '', 0, false, 'T', 'M');
