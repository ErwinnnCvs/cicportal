...
$get_all_seps_sub=$dbh4->query("SELECT a.fld_ctrlno, a.fld_type, AES_DECRYPT(a.fld_provcode, md5(CONCAT(a.fld_ctrlno, 'RA3019'))) as fld_provcode, AES_DECRYPT(a.fld_name, md5(CONCAT(fld_ctrlno, 'RA3019'))) as fld_name, b.fld_assign FROM tbentities a LEFT JOIN tbassign b ON AES_DECRYPT(a.fld_provcode, md5(CONCAT(a.fld_ctrlno, 'RA3019'))) = b.fld_provcode WHERE AES_DECRYPT(a.fld_provcode, md5(CONCAT(a.fld_ctrlno, 'RA3019'))) <> '' AND b.fld_assign <> '' AND b.fld_type = 1".$query." GROUP BY AES_DECRYPT(a.fld_provcode, md5(CONCAT(a.fld_ctrlno, 'RA3019'))) ORDER BY fld_cms_last_update ASC LIMIT 1");
...
foreach ($casemanagement_arr as $inskey => $insval) {
    ...
    if ($ceicm['fld_provcode']) {
      ...
      echo "INSERT INTO tbcasemanagement2 (fld_provcode, fld_entity, fld_lastlogin, fld_tickets, fld_missed_months, fld_last_submitted, fld_last_loaded, fld_action, fld_cic_remarks) VALUES ('".$insval['PROVCODE']."', '".$insval['SENAME']."', '".$insval['LASTLOGIN']."', '".$insval['TICKETS']."', '".$insval['MISSEDMONTHS']."', '".$insval['LASTSUBMITTED']."', '".$insval['LASTLOADED']."', '".$insval['TICKETS']."', '".$insval['SYSTEMREMARKS']."')<br>";
      $dbh->query("INSERT INTO tbcasemanagement2 (fld_provcode, fld_entity, fld_lastlogin, fld_tickets, fld_missed_months, fld_last_submitted, fld_last_loaded, fld_action, fld_cic_remarks, fld_type, fld_assign) VALUES ('".$insval['PROVCODE']."', '".$insval['SENAME']."', '".$insval['LASTLOGIN']."', '".$insval['TICKETS']."', '".$insval['MISSEDMONTHS']."', '".$insval['LASTSUBMITTED']."', '".$insval['LASTLOADED']."', '".$insval['TICKETS']."', '".$insval['SYSTEMREMARKS']."', 1, ".$insval['ASSIGNTO'].")");
    }
  }
