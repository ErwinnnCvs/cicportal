<?php 
    ...
    FROM tbentities WHERE AES_DECRYPT(fld_provcode, md5(CONCAT(fld_ctrlno, 'RA3019')))= '".$_GET['provCode'] ."'");
        ...
        <div class="row p-3">
            ...
            <div class="col-md-6 col-lg-4">
                <div class="form-group">
                    ...
                    <p><?php echo date("F Y ", strtotime($_GET['dateMonth'])) ?></p>
                </div>
            </div>
							...
							<div class="tab-pane active" id="tab_1">
								<table id="example1" class="table table-bordered text-center">
									...
									<tbody>
                                        ...
                                        $sql2=$dbh4->query("SELECT * FROM tbtransmittal WHERE fld_provcode = '".$_GET['provCode']."' AND  fld_date_covered LIKE '%".$_GET['dateMonth']."%' ");
