...
if ($_POST['sbtCommentSave']) {
  if (!$_POST['selValidationOptions']) {
    ...
    // echo "UPDATE tbextensionicmt SET fld_ext_status = ".$validation.", fld_validate_remarks = '".$remarks."', fld_validate_by = '".$name."', fld_validate_ts = '".$timestamp."' WHERE fld_id = ".$_GET['id']." ;";
    //     die();
    $dbh4->query("UPDATE tbextensionicmt SET fld_ext_status = ".$validation.", fld_approval_remarks = '".$remarks."', fld_approve_by = '".$name."', fld_approve_ts = '".$timestamp."' WHERE fld_id = ".$_GET['id']." ;");
...
$gred['fld_approve_ts'] = date("M d, Y", strtotime($gred['fld_approve_ts']));
$gred['fld_validate_ts'] = date("M d, Y", strtotime($gred['fld_validate_ts']));
...
$selvaloptions = array("1" => "Approve Extension", "2" => "Reject Extension"); 
        ...
        <div class="card-body">
          <form method="post">
            <div class="form-group">
                  ...
                  <?php if($gred['fld_ext_date_ict'] && $gred['fld_ext_date_cnt_ict']){ ?>
                    <div class="form-group">
                    <label>Overidden Extension Date</label>
                    <input type="text" class="form-control" name = "ictDate" value="<?php echo date("F d, Y" , strtotime($gred['fld_ext_date_ict'])); ?>" disabled>
                    </div>
                  <?php } ?>
                  <label>Validation</label>
                  <?php
                  if ($gred['fld_ext_status'] == 3) {
                  ?>
                ...
                ?>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" value="<?php echo $gred['fld_approve_ts']; ?>" disabled>
                  </div>

                  <label>Approval Remarks</label>
                  <textarea class="form-control" name="commentTxt" disabled>
                    <?php
                      echo $gred['fld_approval_remarks'];
                    ?>
                  </textarea>
                <?php
                  }
