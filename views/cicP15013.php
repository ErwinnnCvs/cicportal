...
//echo "SELECT * FROM tbict_freshdesk WHERE fld_ticket_id <> '' AND fld_ctrlno IS NULL AND fld_status IN (2, 3, 9) AND fld_transfer_ts IS NOT NULL";
...
$fetchTickets = $dbh4->query("SELECT * FROM tbict_freshdesk WHERE fld_ticket_id <> '' AND fld_ctrlno IS NULL AND fld_status IN (2, 3, 9) AND fld_transfer_ts IS NOT NULL");
        ...
        <table class="table table-bordered table-striped table-hovered" id="tbAssignSE">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <?php 
                    if ($fchTkts['fld_group_id'] == '33000215508') {
                      echo "LOC";
                    }
                    elseif ($fchTkts['fld_group_id'] == '33000148658') {
                      echo "Data Submission";
                    }
                    elseif ($fchTkts['fld_group_id'] == '33000215509') {
                      echo "UAT";
                    }
                    elseif ($fchTkts['fld_group_id'] == '33000212005') {
                      echo "SE Prod Updates";
                    }
                  ?>
                  ...
                  <div class="modal fade" id="modal-success<?php //echo $ticket_no; ?>">
                          ...
                          <div class="modal-body">
                            <input type="hidden" name="controlno_close" value="<?php //echo (htmlspecialchars($fchTkts['fld_ticket_id'])); ?>">
                              <div class="form-group">
                                ...
                                <input type="text" name="ticket_no" class="form-control" value="<?php //echo $ticket_no; ?>">
                              </div>
