...
$query = "SELECT fld_ctrlno, AES_DECRYPT(fld_provcode, MD5(CONCAT(fld_ctrlno, 'RA3019'))) AS fld_provcode, AES_DECRYPT(fld_name, MD5(CONCAT(fld_ctrlno, 'RA3019'))) AS fld_name, AES_DECRYPT(fld_ip, MD5(CONCAT(fld_ctrlno, 'RA3019'))) AS fld_ip,fld_type, fld_ts1, fld_status, fld_ts_ipresub, fld_changed_ip_status, fld_changed_ip_timestamp, fld_mnemonics, fld_changed_ip_remarks FROM tbentities WHERE fld_status = 0 and fld_ip <> AES_ENCRYPT('will avail 2fa', md5(CONCAT(fld_ctrlno, 'RA3019'))) and fld_process_status = 2 or fld_status = 0 and fld_ip <> AES_ENCRYPT('will avail 2fa', md5(CONCAT(fld_ctrlno, 'RA3019'))) and fld_process_status = 3 or fld_changed_ip_status = 1";
        ...
        <div class="card-header">
          ...
          <div class="input-group-prepend">
            ...
            <ul class="dropdown-menu">
              <li class="dropdown-item"><a href="main.php?nid=12&sid=0&rid=0">Pending</a></li>
              <li class="dropdown-item"><a href="main.php?nid=12&sid=1&rid=1">Incomplete</a></li>
              <li class="dropdown-item"><a href="main.php?nid=12&sid=2&rid=1">Completed</a></li>
            </ul>
          </div>
          <!-- /btn-group -->
        </div>
            ...
            <tbody>
              <?php
                ...
                while ($gae=$get_all_entities->fetch_array()) {
                  $datetime = date("F d, Y h:ia", strtotime($gae['fld_ts1']));
              ?>
              <tr>
                <td><?php echo $gae['fld_provcode']; ?></td>
                <td><a href="main.php?nid=12&sid=1&rid=1&ctrlno=<?php echo $gae['fld_ctrlno']; ?>"><?php echo $gae['fld_name']; ?></a></td>
