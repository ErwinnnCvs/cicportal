...
if ($_GET['nid'] == 7 and $_GET['sid'] == 1 and $_GET['rid'] == 1) {
    ...
    <div class="card-body">
      ...
      <table class="table table-bordered table-hover">
        ...
        <tbody>
         <?php
         #CIBI        
          $get_cibi_inquiry_month = $dbh->query("SELECT fld_provcode, SUM(fld_inqcount) as inqcnt, SUM(fld_inq_price) as inqprice FROM tbinquiries WHERE YEAR(fld_inqdate) = '".$det[0]."' and MONTH(fld_inqdate) = '".$det[1]."' AND (fld_provcode = 'SAE09670' OR fld_branchcode = 'SCIBI' OR (fld_branchcode LIKE 'SAE%' AND fld_usercode LIKE '%CIB')) AND ((fld_sourcecode = 'CB_ME' AND fld_errorcode = 'NULL') OR (fld_sourcecode = 'CB_NAE' AND fld_errorcode = 'NULL') OR (fld_sourcecode = 'CB_ME' AND fld_errorcode LIKE '%1-100%') OR (fld_sourcecode = 'CB_CE' AND fld_errorcode = 'NULL') OR (fld_sourcecode = 'CB_CE' AND fld_errorcode LIKE '%1-100%')) GROUP BY fld_provcode");
