					...
					<!-- <ul class="nav nav-tabs" id="custom-tabs-four-tab" role="tablist">
						...
						<div class="tab-content p-2">
							...
							<div class="tab-pane active" id="tab_1">
								<table id="disputeIngestionQ1" class="table table-bordered table-responsive text-center">
									<thead>
									...
									<tbody>
										<?php
											...
											// c.fld_id > 9434
											$get_filed_disputes = $dbh2->query( "SELECT * from ingestion where fld_id < 817; " );
											while ($gfd = $get_filed_disputes->fetch_array()) {

		
										?>
										<tr>
											<form method="post" action="main.php?nid=151&sid=0&rid=0">
