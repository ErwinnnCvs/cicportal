      ...
      <table class="table table-bordered" id="merging_pending">
        ...
        <tbody>
          <?php
            ...
            $get_all_merging_requests=$dbh4->query("SELECT fld_id, fld_ctrlno, AES_DECRYPT(fld_provcode, md5(CONCAT(fld_ctrlno, 'RA3019'))) as provcode, AES_DECRYPT(fld_fname, md5(CONCAT(fld_ctrlno, 'RA3019'))) as fname, AES_DECRYPT(fld_mname, md5(CONCAT(fld_ctrlno, 'RA3019'))) as mname, AES_DECRYPT(fld_lname, md5(CONCAT(fld_ctrlno, 'RA3019'))) as lname, fld_sex, AES_DECRYPT(fld_tin, md5(CONCAT(fld_ctrlno, 'RA3019'))) as tin, fld_status, fld_user, fld_cic_remarks, fld_cic_ts, fld_merged_by, fld_birthdate, fld_inserted_ts, fld_id_type, AES_DECRYPT(fld_id_number, md5(CONCAT(fld_ctrlno, 'RA3019'))) as fld_id_number FROM tbmerging WHERE fld_status <= 1".$srch." ORDER BY fld_inserted_ts DESC LIMIT ".key($_POST['navbutton']).", 10");
          ...
          <tr>
            ...
            <td>
              ...
              <?php if($gamr['fld_status'] == 0) { ?>
                <center><button type="submit" class="btn btn-warning btn-block" name="sbtPendingMerge" value="<?php echo $gamr['fld_id']; ?>">
                  Pending
                </button></center>
            <?php } elseif($gamr['fld_status'] == 1) {
              ?>
              <center><button type="submit" name="sbtPendingMerge" value="<?php echo $gamr['fld_id']; ?>" class="btn btn-info btn-block">Ongoing Process</button></center>
            <?php
            }
            ?>
      ...
      <div class="row"> 
        <div class="col-xs-6" align="right">
          ...
          <?php
            ...
            $get_all_merging_requests_cnt=$dbh4->query("SELECT COUNT(*) as rcnt FROM tbmerging WHERE fld_status <= 1".$srch." ORDER BY fld_inserted_ts DESC");
