...
if ($_POST['sbtCEPortalYes']) {
  if ($dbh4->query("UPDATE tbentities SET fld_uat_ceportal_resend_by = '".$_SESSION['name']."', fld_uat_ceportal_resend_ts = '".$timestamp."', fld_uat_ceportal_sent = 1 WHERE fld_ctrlno = '".$controlno."'")) {
    $dbh->query("UPDATE tbusers SET is_active = 0 WHERE fld_ctrlno = '".$controlno."'");
    $msg = "CE Portal access was sent.";
    $msgclr = "success";
  } else {
    $msg = "Error updating";
    $msgclr = "danger";
  ...
  <div class="card">
    <div class="card-header d-flex p-0">
      ...
      <ul class="nav nav-pills ml-auto p-2">
        ...
        <li class="nav-item"><a class="nav-link" href="#tab_2" data-toggle="modal" data-target="#modal-default">Resend Online Registration Link</a></li>
        
        <li class="nav-item"><a class="nav-link" href="#tab_2" data-toggle="modal" data-target="#modal-ceportal">Resend CE Portal Access</a></li>
        ...
        <div class="modal fade" id="modal-ceportal">
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <h4 class="modal-title">Confirmation..</h4>
              ...
              <div class="modal-body">
                Are you sure you want to resend CE Portal Access for <b><?php echo $ged['name']; ?></b>? <br>
                <span><small>This will create and resend new credentials to their Current PCP.</small></span>
              </div>
              <form method="post">
                <div class="modal-footer justify-content-between">
                  <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
                  <button type="submit" value="1" name="sbtCEPortalYes" class="btn btn-primary">Yes</button>
                </div>
              </form>
            </div>
            <!-- /.modal-content -->
              ...
              <!-- form start -->
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="name" name="name" value="<?php echo $ged['name']; ?>">
                  </div>
                </div>
            </div>
          </div>
