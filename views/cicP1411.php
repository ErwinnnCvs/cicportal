...
$get_entity_details = $dbh4->query("SELECT fld_ctrlno, AES_DECRYPT(fld_tinno, MD5(CONCAT(fld_ctrlno, 'RA3019'))) AS fld_tinno,
        ...
        fld_re_validation_status FROM tbentities WHERE fld_ctrlno = '".$controlno."' and fld_registration_type = 4");
...
if ($ged['fld_ctrlno']) {
  ...
  if ($_POST['sbtReject']) {
    ...
    // if ($dbh->query("INSERT INTO tbrevalidation_remarks (fld_ctrlno, fld_validation, fld_status, fld_comments, fld_ts, fld_comment_by) VALUES ('".$controlno."', '4', '1', '".$txt."', '".$timestamp."', '".$_SESSION['name']."')")) {
      if ($dbh4->query("UPDATE tbentities SET fld_dqua_validation_exemption_status = 2, fld_dqua_validation_exemption_rej_ts = '".$timestamp."', fld_dqua_validation_exemption_by = '".$_SESSION['name']."', fld_dqua_validation_exemption_remarks = '".addslashes($_POST['dquaValApprTxt'])."' WHERE fld_ctrlno = '".$controlno."'" )) {
    ...
    // if ($dbh->query("INSERT INTO tbrevalidation_remarks (fld_ctrlno, fld_validation, fld_status, fld_comments, fld_ts, fld_comment_by) VALUES ('".$controlno."', '5', '1', '".$txt."', '".$timestamp."', '".$_SESSION['name']."')")) {
      if ($dbh4->query("UPDATE tbentities SET fld_dqua_validation_exemption_status = 1, fld_dqua_validation_exemption_appr_ts = '".$timestamp."', fld_dqua_validation_exemption_by = '".$_SESSION['name']."', fld_dqua_validation_exemption_remarks = '".addslashes($_POST['dquaValApprTxt'])."', fld_dqua_cert_appr_ts = '".$timestamp."', fld_dqua_report_appr_ts = '".$timestamp."' WHERE fld_ctrlno = '".$controlno."'")) {
        $msg = "Successfuly upated";
        $msgclr = "success";
      }
    // }
    ...
    <div class="col-6">
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">DQUA Entity Details</h3>
        </div>
        <div class="card-body">
          <div class="row">
            <div class="col-md-6">
    ...
    <div class="col-6">
          ...
          <ul class="mailbox-attachments d-flex align-items-stretch clearfix">
            <li>
              ...
              <div class="mailbox-attachment-info">
                <a href="#" id="seis-document-link" class="mailbox-attachment-name" data-toggle="modal" data-target="#seis-document"><i class="fas fa-paperclip"></i> DQUA Report.pdf</a>
            ...
            <div class="modal-dialog modal-lg">
              <div class="modal-content">
                <div class="modal-header">
                  <h4 class="modal-title">DQUA Exemption Document</h4>
                ...
                <div class="modal-body">
                  <?php
                    $file = $url_docs."DQUA_REQ_EXEMPTION_".$controlno.".pdf";
                    $handle = @fopen($file, 'r');
                    if (!$handle) {
                  ?>
                  ...
                  ?>
                  <embed src="<?php echo $url_docs."DQUA_REQ_EXEMPTION_".$controlno.".pdf"; ?>#toolbar=0" width="750" height="1000"></embed>
                  <?php
                    }
                  ?>
                </div>
      ...
      <div class="card">
        ...
        <div class="card-body">
          <form method="post">
            <label>Remarks:</label>
            <textarea class="form-control" name="dquaValApprTxt"></textarea>
            <br>
            <br>
