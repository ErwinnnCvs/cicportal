    ...
    <div class="card-header">
      <div class="input-group-prepend">
        ...
        <ul class="dropdown-menu">
          <li class="dropdown-item"><a href="main.php?nid=131&sid=0&rid=0">Pending</a></li>
          <li class="dropdown-item"><a href="main.php?nid=131&sid=1&rid=1">Endorsed</a></li>
        </ul>
      </div>
    </div>
    <div class="card-body">
      <div class="table-responsive">
        <table class="table text-center">
            ...
            <tbody>
                <?php
                $counter = 1;
                    $get_all_pending_requests = $dbh4->query("SELECT * FROM tbrequestextension WHERE fld_status = 0 ORDER BY fld_date_requested DESC");
                ...
                <tr>
                    ...
                    <td>
                        <a href="main.php?nid=131&sid=1&rid=0&id=<?php echo $gapr['fld_id']; ?>" class="btn btn-primary">View Request</a>
                    </td>
                </tr>
                <?php
                    }
