    ...
    <div class="card-header">
      <div class="input-group-prepend">
        ...
        <ul class="dropdown-menu">
          ...
          <li class="dropdown-item"><a href="main.php?nid=137&sid=2&rid=0">Approved</a></li>
      ...
      <div class="table-responsive">
        <table class="table text-center">
            ...
            <tbody>
                ...
                $getPendingSessions = $dbh4->query("SELECT fld_ctrlno, fld_provcode, fld_schedule_date, fld_process_type, fld_status, fld_schedule_ts, GROUP_CONCAT(fld_name SEPARATOR ', ') AS attendees , GROUP_CONCAT(fld_id SEPARATOR '|') AS ids from tbmicrosession where fld_status = 1 group by fld_schedule_date order by fld_schedule_ts desc");
