    ...
    <div id="myDIV" style="display:none" class="center1">
      ...
      <div class="form-group mb-3" >
        <span style="white-space: nowrap">
                              <label for='condition' class="main8" style="font-weight: normal;">Trainer (Hands-On): </label> 
                                <select name="secondtrainer" id="secondtrainer" class="form-control1" style="height: 28px;" required>
    ...
    <table border="3" class="center" id="customers">
      ...
      <tbody>
        ...
        if (mysqli_connect_errno())
          ...
          $query=mysqli_query($conn," select * from trainer ORDER BY trainingdateone DESC");


          while($row=mysqli_fetch_array($query)){

            $date = date("F d, Y",strtotime ($row['trainingdateone']));
            $date1 = date("Y-m-d",strtotime ($row['trainingdateone']));
             ?>
