...
<!-- Card Body -->
	<div class="card-body">	
		...
		<div class="card card-info">
			...
			<form method="post" action="main.php?nid=152sid=0&rid=0">
		<div class="col-lg-2">
					...
					<!-- <ul class="nav nav-tabs" id="custom-tabs-four-tab" role="tablist">
						...
						<div class="tab-content p-2">
							...
							<div class="tab-pane active" id="tab_1">
								<table id="disputeIngestionQ2" class="table table-bordered table-responsive text-center">
									<thead>
									...
									<tbody>
										<?php
											...
											// c.fld_id > 9434
											$get_filed_disputes = $dbh2->query( "SELECT * from ingestion where fld_id > 817 and fld_id < 2325; " );
											while ($gfd = $get_filed_disputes->fetch_array()) {

		
										?>
										<tr>
											<form method="post" action="main.php?nid=152&sid=0&rid=0">
