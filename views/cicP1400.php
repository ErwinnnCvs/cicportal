        ...
        <div class="card-body table-responsive p-0" style="height: 700px;">
          <table class="table table-head-fixed text-nowrap">
            ...
            <tbody>
              ...
              $get_pae_details_status = $dbh4->query("SELECT fld_ctrlno, aes_decrypt(fld_name, md5(CONCAT(fld_ctrlno, 'RA3019'))) as name, aes_decrypt(fld_provcode, md5(CONCAT(fld_ctrlno, 'RA3019'))) as provcode, fld_type, fld_dqua_exemption_ts FROM tbentities WHERE fld_dqua_exemption_status = 1 and fld_dqua_exemption_ts IS NOT NULL and fld_dqua_validation_exemption_status = 0");
              while($gpds=$get_pae_details_status->fetch_array()){
              $datetime = date("F d, Y h:ia", strtotime($gpds['fld_dqua_exemption_ts']));

              ?>
              <tr>
                <td><?php echo $gpds['provcode']; ?></td>
                <td><a href="main.php?nid=14&sid=1&rid=1&ctrlno=<?php echo $gpds['fld_ctrlno']; ?>"><?php echo $gpds['name']; ?></a></td>
