...
if ($ged['fld_ctrlno']) {
  ...
  if ($_POST['sbtReject']) {
    ...
    // if ($dbh->query("INSERT INTO tbrevalidation_remarks (fld_ctrlno, fld_validation, fld_status, fld_comments, fld_ts, fld_comment_by) VALUES ('".$controlno."', '4', '1', '".$txt."', '".$timestamp."', '".$_SESSION['name']."')")) {
      if ($dbh4->query("UPDATE tbentities SET fld_dqua_report_status = 2, fld_dqua_report_rej_ts = '".$timestamp."', fld_dqua_report_by = '".$_SESSION['name']."' WHERE fld_ctrlno = '".$controlno."'" )) {
    ...
    // if ($dbh->query("INSERT INTO tbrevalidation_remarks (fld_ctrlno, fld_validation, fld_status, fld_comments, fld_ts, fld_comment_by) VALUES ('".$controlno."', '5', '1', '".$txt."', '".$timestamp."', '".$_SESSION['name']."')")) {
      if ($dbh4->query("UPDATE tbentities SET fld_dqua_report_status = 1, fld_dqua_report_appr_ts = '".$timestamp."', fld_dqua_report_by = '".$_SESSION['name']."' WHERE fld_ctrlno = '".$controlno."'")) {
        $msg = "Successfuly upated";
        $msgclr = "success";
      }
    // }
    ...
    <div class="col-6">
            ...
            <div class="modal-dialog modal-lg">
              <div class="modal-content">
                <div class="modal-header">
                  <h4 class="modal-title">DQUA Report Document</h4>
                ...
                <div class="modal-body">
                  <?php
                    $file = $url_docs."DQUA_SAE_REP_".$controlno."_".$ged['fld_dqua_sae_selected'].".pdf";
                    $handle = @fopen($file, 'r');
                    if (!$handle) {
                  ?>
                  ...
                  ?>
                  <embed src="<?php echo $url_docs."DQUA_SAE_REP_".$controlno."_".$ged['fld_dqua_sae_selected'].".pdf"; ?>#toolbar=0" width="750" height="1000"></embed>
                  <?php
                    }
                  ?>
                </div>
      ...
      <div class="card">
        <div class="card-header d-flex p-0">
          <h3 class="card-title p-3">Action Taken</h3>
        </div><!-- /.card-header -->
        <div class="card-body">
          <form method="post">
            <label>Remarks:</label>
