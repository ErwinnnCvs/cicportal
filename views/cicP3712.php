<?php
    if($_POST['sbtProdConfirmation']){
        if($dbh4->query("UPDATE tbentities SET fld_se_testing_status = 3, fld_se_confirmed_by = '".$_SESSION['name']."', fld_se_confirmed_ts = '".date("Y-m-d H:i:s")."', fld_se_prod_email = '1' WHERE fld_ctrlno = '".$_POST['ctrlno']."';")){
        ...
        <tbody>
                ...
                ?>
                    ...
                    <tr>
                        ...
                        <td>
                          <center>
                          <button type="submit" name="sbtProdConfirmation" class="btn btn-success btn-block" value="1">Confirm</button>
                          </center>
