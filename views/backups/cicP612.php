...
if ($_GET['nid'] == 6 and $_GET['sid'] == 1 and $_GET['rid'] == 2) {
        ...
        <tbody>
         ...
         #CIBI
          ...
          while($gcim=$get_crif_inquiry_month->fetch_array()){
            ...
            if ($gcim['fld_branchcode'] == "SCRIF") {
              $sae_provider_code = "SAE09440";
            }
