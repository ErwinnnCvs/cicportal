...
if ($ged['fld_ctrlno']) {
  ...
  if ($_POST['sbtReject']) {
    ...
    // if ($dbh->query("INSERT INTO tbrevalidation_remarks (fld_ctrlno, fld_validation, fld_status, fld_comments, fld_ts, fld_comment_by) VALUES ('".$controlno."', '4', '1', '".$txt."', '".$timestamp."', '".$_SESSION['name']."')")) {
      if ($dbh4->query("UPDATE tbentities SET fld_dqua_validation_approval_status = 2, fld_dqua_validation_approval_rej_ts = '".$timestamp."', fld_dqua_validation_approval_by = '".$_SESSION['name']."' WHERE fld_ctrlno = '".$controlno."'" )) {
    ...
    // if ($dbh->query("INSERT INTO tbrevalidation_remarks (fld_ctrlno, fld_validation, fld_status, fld_comments, fld_ts, fld_comment_by) VALUES ('".$controlno."', '5', '1', '".$txt."', '".$timestamp."', '".$_SESSION['name']."')")) {
      if ($dbh4->query("UPDATE tbentities SET fld_dqua_validation_approval_status = 1, fld_dqua_validation_approval_ts = '".$timestamp."', fld_dqua_validation_approval_by = '".$_SESSION['name']."', fld_dqua_validation_approval_remarks = '".addslashes($_POST['dquaValApprTxt'])."' WHERE fld_ctrlno = '".$controlno."'")) {
        $msg = "Successfuly upated";
        $msgclr = "success";
      } else {
