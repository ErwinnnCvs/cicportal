<?php
  ...
  if ($_POST['sbtReturn']) {
    ...
    if ($dbh2->query("UPDATE contract SET fld_subjcode_remarks = '".$new_remarks."', fld_subjcode_by = '".$_SESSION['name']."', fld_disp_status = 0 WHERE fld_id = '".$_POST['fld_id']."'")) {
    }
  }
  ...
  if ($_POST['sbtResolve']) {
    ...
    // $new_remarks = addslashes($remarks.$gpr['fld_subjcode_remarks']);
    if ($dbh2->query("UPDATE contract SET fld_disp_status = 2, fld_disp_ts = '".date("Y-m-d H:i:s")."' WHERE fld_id = '".$_POST['fld_id']."'")) {
    }
  }
?>
...
<section class="content">
  ...
  <div class="card">
    ...
    <div class="card-body">
      <table class="table table-bordered" id="dispute_resolve">
        <thead>
          <tr>
              ...
              <center>
                <form method="post">
                  ...
                  <?php
                    if($gfd['subjcode']){
                  ?>
                  <button type="submit" name="sbtResolve" value="1" class="btn btn-success btn-block">Resolve</button>
                  <?php
                    } else {
                  ?>
                  <label>NO SUBJECT CODE</label>
                  <?php
                    }
                  ?>
