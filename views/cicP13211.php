      ...
      <div class="table-responsive">
        <table class="table text-center">
            ...
            <tbody>
                <?php
                $counter = 1;
                    $get_all_pending_requests = $dbh4->query("SELECT * FROM tbrequestextension WHERE fld_status = 2 ORDER BY fld_endorsed_ts DESC");
                ...
                <tr>
                    ...
                    <td><?php echo ($gapr['fld_approved_by'] ? $gapr['fld_approved_by'] : 'AUTO SYSTEM APPROVAL'); ?></td>
                    <td><?php echo ($gapr['fld_approved_ts'] ? date("F d, Y h:i A", strtotime($gapr['fld_approved_ts'])) : date("F d, Y", strtotime($gapr['fld_date_requested'] . ' + 5 days'))); ?></td>
                    <td>
