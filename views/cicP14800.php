    ...
    <div class="card-body">
      <div class="table-responsive">
        <table class="table text-center">
            ...
            <?php
                $counter = 1;
                    $get_all_pending_requests = $dbh4->query("SELECT * FROM tbextensionicmt WHERE fld_ext_status = 3 ORDER BY fld_validate_ts DESC");
                    while ($gapr=$get_all_pending_requests->fetch_array()) {

                        $getValidatorName = $dbh5->query("SELECT * from tbusers where pkUserId = '".$gapr['fld_filed_by']."' ");
                ...
                <input type="hidden" name="id_request" id="id_request" value="<?php echo $gapr['fld_id']; ?>">
                    ...
                    <td>
                        <a href="main.php?nid=148&sid=1&rid=0&id=<?php echo $gapr['fld_id']; ?>" class="btn btn-primary">View Request</a>
                    </td>
                </tr>
                <?php
                    }
