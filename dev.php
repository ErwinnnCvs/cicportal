...
if (!isset($_SESSION['user_id'])) {
  ...
  $oprtrs = array("CIC140007" => "Hannah", "CIC130001" => "Genie", "CIC160025" => "Josan", "CIC160046" => "Trixie", "CIC170048" => "Nina", "CIC170049" => "Claude", "CIC170026" => "Hanselle", "CIC170027" => "Reyce", "CIC170021" => "Krystal", "CIC200074" => "Vivian");
...
<div class="wrapper">
  ...
  <?php
    ...
    if (in_array($_SESSION['user_id'], $get_user_access) or $_SESSION['usertype'] == 0) {
      if ($gpm['fld_maintenance'] == 1 and $_SESSION['usertype'] != 0) {
  ?>
  ...
  <div class="content-wrapper">
    ...
    <?php
      ...
      if (file_exists($page_location)) {
        include("views/cicP3320_test.php");
      } else {
    ?>
    <!-- Main content -->
    <section class="content">
