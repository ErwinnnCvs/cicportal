...
$ticket_date = date("2024-08-10");
$updated_date = date("2024-08-11");
...
foreach ($pages as $num) {
    ...
    $created = '(created_at:%27'.$ticket_date.'%27%20OR%20updated_at:%27'.$updated_date.'%27)';
            ...
            if($subject){
                ...
                // if($se_provcode == $provider_code){
                    ...
                    if($cii['fld_id']){
                        ...
                        echo "INSERT INTO tbprodtickets (fld_id, fld_provcode, fld_subject, fld_created_time, fld_transmittal_status) VALUES ('".$item['id']."', '".$provcode."', '".$file_name."', '".$date_created2."', 0)<br>";
