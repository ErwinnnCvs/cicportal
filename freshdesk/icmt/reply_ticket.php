...
$getFreshdeskId = $dbh->query("SELECT * from tbictpersonnel WHERE fld_userid = '".$_SESSION['user_id']."' LIMIT 1");
...
//echo $user['fld_freshdesk_id'] . "working";

$reply_payload = array(
	'body' => $_POST['compose-textarea'],
	//'cc_emails' => array("maryluz.formaran@creditinfo.gov.ph")
	//'body' => "TEST REPLY",
