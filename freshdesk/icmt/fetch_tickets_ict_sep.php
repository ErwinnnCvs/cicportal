...
$getLastFetchedTimestamp = $dbh4->query("SELECT fld_last_fetched_ts FROM `tbict_freshdesk` WHERE fld_last_fetched_ts IS NOT NULL AND fld_group_id = 33000212005 ORDER BY fld_last_fetched_ts DESC LIMIT 1");
...
foreach($pages as $page) {
	$url = 'https://creditinfoph.freshdesk.com/api/v2/search/tickets?page='.$page.'&query="(group_id:33000212005)'.$filter.'"';
	
	//$url = 'https://creditinfoph.freshdesk.com/api/v2/search/tickets?page='.$page.'&query="(group_id:33000212005)"';
