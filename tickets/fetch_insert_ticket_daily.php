...
// foreach ($pages as $num) {
    ...
    $query = "created_at: '".$ticket_date."' OR updated_at: '".$ticket_date."'";
    // $url = 'https://creditinfoph.freshdesk.com/api/v2/search/tickets?page='.$i.'&query="'.$created.'"';
    $url = 'https://creditinfoph.freshdesk.com/api/v2/search/tickets?page='.$i.'&query="'.rawurlencode($query).'"';
    ...
    if($info['http_code'] == 200) {
        ...
        foreach ($obj['results'] as $item) {
            // echo $item['to_emails'];
            echo "<b>ID</b>: ".$item['id']. "; <br> <b>SUBJECT</b>: " .$item['subject']. ";<br> <b>DESCRIPTION</b>: " .$item['description'].";<br> <b>TAGS</b>: ";
        ...
        //                 echo $item['id']. " - ". $matches[0]." - " .$file_name. "  " . $date_created2 . " NOT IN DATABASE; INSERTING....\n";
