...
// $getFile = $dbh4->query("SELECT fld_icmt_approval_files, fld_ctrlno FROM `tbentities` WHERE fld_ctrlno = '".$ctrl_no."'");
// $gf = $getFile->fetch_array();
...
$mail->Subject = "Issuance of a Letter of Compliance (" . $ctrl_no . ")";
                     ...
                     <tbody>
                        <tr height="20px" rowspan="1" colspan="3">
                           <td style="max-width: 645px; word-wrap: break-word;font-family:Roboto-Regular,Helvetica,Arial,sans-serif;font-size:14px;color:black;line-height:1.25;min-width:300px;padding:10px 30px 15px;" id="editTR">
                                <center><b style="text-transform: uppercase"><u> LETTER OF COMPLIANCE </u></b></center><br/>'.
                                    '<br/>
                                    This letter is being issued for your failure to attend the mandated technical training sessions without any justifiable reason.<br/><br/>
                                        
                                    Despite reasonable efforts from the CIC to assist you to comply with CIC Circular No. 2023-04 entitled <i>Implementing Guidelines for the Compliance of all Submitting Entities under the 
                                    Credit Information Systems Act</i> (“Guidelines”), you still failed to fulfill your obligations under Republic Act No. 9510 or the <i>“Credit Information System Act of 2008”</i>.<br/><br/>

                                    <b>IN VIEW OF YOUR CONTINUOUS DEFIANCE OF THE LAW, YOU ARE HEREBY ORDERED AND REQUIRED TO UNDERTAKE ALL NECESSARY ACTIONS, WITHOUT ANY HINT OF DELAY, TO COMPLY WITH THE GUIDELINES WITHIN FIVE (5) 
                                    WORKING DAYS FROM THE DATE THAT THIS LETTER HAS BEEN SENT. OTHERWISE, THE CIC SHALL REPORT YOU TO THE APPROPRIATE GOVERNMENT REGULATORY AGENCY FOR THEIR ACTION. </b><br/><br/>
                           </td>
                        </tr>
                     </tbody>
                  </table>
