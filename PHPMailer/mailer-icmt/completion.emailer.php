...
$mail->Subject = 'COMPLETION OF STAGE ' . $stageNo .' (' . $cs_tb['fld_ctrlno'] . ')';
                     ...
                     <tbody>
                        <tr height="20px" rowspan="1" colspan="3">
                           <td style="max-width: 645px; word-wrap: break-word;font-family:Roboto-Regular,Helvetica,Arial,sans-serif;font-size:14px;color:black;line-height:1.25;min-width:300px;padding:10px 30px 15px;" id="editTR">
                                ...
                                We are pleased to inform you that you have successfully completed Stage '.$stageNo.' of Initial Compliance, which is the '.$currProcess.' process. You are now ready to proceed to Stage '.$processType.'. <br/><br/>
...
if ($mail->send()) {
    $insert = $dbh4->query("INSERT INTO tbict_emailer (fld_ctrlno, fld_subject, fld_datesent, fld_emailer_type) VALUES ('$cs_tb[fld_ctrlno]', '$mail->Subject', '$datetoday', '$stageNo')");
