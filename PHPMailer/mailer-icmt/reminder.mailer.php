...
$mail->Subject = 'REMINDER TO ACCOMPLISH STAGE ' . $stage . ' OF THE INITIAL COMPLIANCE PROCESS (' . $cs_tb['fld_ctrlno'] . ')';
                     ...
                     <tbody>
                        <tr height="20px" rowspan="1" colspan="3">
                           <td style="max-width: 645px; word-wrap: break-word;font-family:Roboto-Regular,Helvetica,Arial,sans-serif;font-size:14px;color:black;line-height:1.25;min-width:300px;padding:10px 30px 15px;" id="editTR">
                                <center><b style="text-transform: uppercase"><u> REMINDER TO ACCOMPLISH STAGE ' . $stage . ' OF THE INITIAL COMPLIANCE PROCESS </u></b></center><br/>'.
                                    '<br/>
                                    This is a gentle reminder to finish Stage ' . $stage . ' of the Initial Compliance under CIC Circular No. 2023-04 or the  Implementing Guidelines for the Compliance of all Submitting Entities under the Credit Information Systems Act. 
                                    <b> Please ensure that all documentary requirements, as well as all necessary actions for Stage ' . $stage . ',  are accomplished within the remaining period to comply or within ' . $days . ' working days from the date of this reminder. </b><br/><br/>

                                    For your information and guidance, you may view the Implementing Guidelines for the Compliance of all Submitting Entities covered by RA 9510 or the Credit Information System Act (“CISA”) and its Implementing Rules and Regulations 
                                    <a href="https://www.creditinfo.gov.ph/sites/default/files/CIC%20Circular%20No.%202023-04_Implementing%20Guidelines%20for%20the%20Compliance%20of%20All%20Submitting%20Entities%20under%20the%20Credit%20Information%20Systems%20Act%20%28ONAR%20received%29_0.pdf">here</a>.<br/><br/>

                                    If you have already completed the Stage ' . $stage . ', please disregard this reminder.<br/><br/>
                                    ...
                                    Thank you for your utmost cooperation in complying with CISA.
                           </td>
                        </tr>
                     </tbody>
                  </table>
...
if ($mail->send()) {
    $insert = $dbh4->query("INSERT INTO tbict_emailer (fld_ctrlno, fld_subject, fld_datesent, fld_emailer_type) VALUES ('$cs_tb[fld_ctrlno]', '$mail->Subject', '$datetoday', '4')");
