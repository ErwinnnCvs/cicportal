...
OIC President and CEO, duly authorized signatory, <b>Atty. Aileen L. Amor-Bautista</b>, (hereinafter referred to as the “CIC”);</td>
        <td></td>
    </tr>
</table>';
...
2020 (start date) and shall remain in force and effect until ______________________ unless
...
$pdf->setCellMargins(0, 0, 0, 0);
$pdf->SetFont('helvetica', 'B', 11);
$pdf->MultiCell(0, 5, "ATTY. AILEEN L. AMOR-BAUTISTA", 0, 'C', 0, 0, '', '', true);
$pdf->SetFont('helvetica', '', 11);
$pdf->Ln();
$pdf->MultiCell(0, 5, "Officer-in-Charge", 0, 'C', 0, 0, '', '', true);
$pdf->Ln();
...
pdfEncrypt($uploadsPath, $password, $destFile);
