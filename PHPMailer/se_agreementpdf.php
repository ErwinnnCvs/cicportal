...
$pdf->MultiCell(90, 5, ($res['fname_ar'].($res['mname_ar']? " ".substr($res['mname_ar'], 0, 1).'.':'')." ".$res['lname_ar'].($res['extname_ar']? " ".$res['extname_ar']:'')), 'B', 'L', 0, 1, '', '', true);
$pdf->MultiCell(50, 5, "DESIGNATION\n", 0, 'L', 0, 0, '', '', true);
$pdf->MultiCell(90, 5, $res['position_ar'], 'B', 'L', 0, 1, '', '', true);
$pdf->MultiCell(50, 5, "OFFICE ADDRESS\n", 0, 'L', 0, 0, '', '', true);
$pdf->MultiCell(90, 5, $office, 'B', 'L', 0, 1, '', '', true);
$pdf->MultiCell(50, 5, "PHONE NUMBER\n", 0, 'L', 0, 0, '', '', true);
$pdf->MultiCell(90, 5, $phone, 'B', 'L', 0, 1, '', '', true);
$pdf->MultiCell(50, 5, "E-MAIL ADDRESS\n", 0, 'L', 0, 0, '', '', true);
$pdf->MultiCell(90, 5, $res['email_ar'], 'B', 'L', 0, 1, '', '', true);

$pdf->lastPage();
$pdf->Output('../pdf/AGR_'.$res['provcode'].'_'.$sae['provcode'].'_TOSE.pdf', 'F');
